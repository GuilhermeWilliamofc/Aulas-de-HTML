...
var data_e_hora_artigo_impresso = document.getElementById('artigo')
data_e_hora_artigo_impresso.innerHTML = `Esse artigo foi impresso no dia ${dia_atual} de ${mes_atual} de ${ano_atual} às ${hora_atual}:${min_atual}`
